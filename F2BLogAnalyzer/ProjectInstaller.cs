...
namespace F2B
{
    ...
    public partial class ProjectInstaller : Installer
    {
        ...
        public ProjectInstaller()
        {
            ...
            serviceInstaller.ServicesDependedOn = new string[] { "eventlog", "BFE", "MSMQ" };
        ...
        protected override void OnBeforeInstall(System.Collections.IDictionary savedState)
        {
            ...
            if (Context.Parameters.ContainsKey("f2bConfig"))
            {
                Context.Parameters["assemblypath"] = AppendPathParameter(Context.Parameters["assemblypath"], "/config " + Context.Parameters["f2bConfig"]);
            }
